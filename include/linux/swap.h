...
//ksg function declaration
extern int ksg_swap_readpage(struct page *page, bool do_poll, swp_entry_t entry);
extern int ksg_swap_writepage(struct page*page, struct writeback_control *wbc,
