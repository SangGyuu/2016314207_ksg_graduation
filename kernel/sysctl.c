...
static struct ctl_table kern_table[] = {
	/* ksg start */
	{
		.procname		= "zram_to_nbd",
		.data 			= &zram_to_nbd,
		.maxlen			= sizeof(unsigned int),
		.mode			= 0644,
		.proc_handler	= zram_to_nbd_handler,
	},
	{
		.procname		= "foreground_uid",
		.data			= &foreground_uid,
		.maxlen			= sizeof(unsigned int),
		.mode			= 0644,
	...
	{
		.procname		= "bulk_prefetcher",
		.data 			= &bulk_prefetcher,
		.maxlen			= sizeof(unsigned int),
		.mode			= 0644,
		.proc_handler	= bulk_prefetcher_handler,
	},	
	/* ksg end */
	{
